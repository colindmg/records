      ...
      {selectedTrack && (
        <>
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="absolute top-32 left-16 flex items-center gap-4 p-4 z-50 bg-[#F1F1F1] rounded-md shadow-sm max-sm:top-16 max-sm:left-1/2 max-sm:-translate-x-1/2"
          >
